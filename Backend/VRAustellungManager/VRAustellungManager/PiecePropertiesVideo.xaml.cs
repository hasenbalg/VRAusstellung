...
namespace VRAustellungManager
{
    ...
    public partial class PiecePropertiesVideo : PiecePropertiesBase
    {
        public Video currentPiece { get; set; }
        protected string FILEFORMATS = "Video files (*.mp4)|*.mp4";

        public PiecePropertiesVideo()
        {
            InitializeComponent();
        ...
        public void SetCurrentPiece(Video currentPiece)
        {
        ...
        protected void FillForm(PieceWithFile currentPiece)
        {
